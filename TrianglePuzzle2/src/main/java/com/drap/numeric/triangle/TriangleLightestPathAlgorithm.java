 ...
 * and calculates the lightest path (from top to bottom) in the triangle.
 * A path can be constructed by taking the value of either the left parent or the right parent.
 * @author David Rappoport
 *
 */
public class TriangleLightestPathAlgorithm extends TrianglePathAlgorithm {
	...
	public NumericShapeOperation getSupportedOperation() {
		return NumericShapeOperation.LIGHTEST_PATH;
	}
